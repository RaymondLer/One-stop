<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Reserve.aspx.cs" Inherits="One_stop.Reserve" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">   
    <div class="container">
        ...
        <asp:Label ID="lblReserve" runat="server" Font-Bold="True" Font-Size="XX-Large" Text="Reserve"></asp:Label>
        ...
        <div class="form-group">
            <div class="col-sm">
                ...
                <asp:RequiredFieldValidator ID="rfvTime" runat="server" ErrorMessage="Please select your time" ControlToValidate="txtTime" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
        ...
        <div class="form-group">
           <div class="col-sm">
                <asp:Calendar ID="datepicker" runat="server" OnSelectionChanged="datepicker_SelectionChanged" BackColor="White" BorderColor="White" BorderWidth="1px" Font-Names="Verdana" Font-Size="9pt" ForeColor="Black" Height="280px" Width="355px" OnDayRender="datepicker_DayRender" NextPrevFormat="FullMonth">
        ...
        <div class="form-group col-md-6">
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Date cannot be empty" ControlToValidate="txtDatepicker" Display="Dynamic" ForeColor="Red"></asp:RequiredFieldValidator>
            <asp:LinkButton ID="lbPickdate" runat="server" OnClick="lbPickdate_Click">Choose Date</asp:LinkButton>
        </div>

        <asp:Button ID="btnReserve" runat="server" Text="Reserve" OnClick="btnReserve_Click" CssClass="btn btn-primary" />
