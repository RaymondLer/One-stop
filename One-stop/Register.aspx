<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="One_stop.Register" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="main" runat="server">
    <div class="container">
        ...
        <%--<p>
            <asp:Label ID="displayStatus" runat="server" Text="Label"></asp:Label>
        </p>--%>
    </div>
</asp:Content>
